...
const pantryItems: PantryItem[] = [
  ...
  ['black-pepper', '黑胡椒', 'Black pepper', 'seasoning'],
  ['chili-oil', '辣椒油', 'Chili oil', 'seasoning'],
  ['chili-bean-paste', '豆瓣酱', 'Chili bean paste', 'seasoning'],
...
const recipes: Recipe[] = [
  ...
  basic(
    'egg-rice',
    '火腿胡萝卜鸡蛋炒饭',
    'Ham and Carrot Egg Fried Rice',
    7,
    ['rice', 'egg', 'carrot', 'ham'],
    ['scallion', 'pea'],
    [
      S('食用油', 'Cooking oil', true, '1 汤匙', '1 tbsp'),
      S('生抽', 'Light soy sauce', false, '不超过 1 茶匙', 'No more than 1 tsp'),
      S('蚝油', 'Oyster sauce', false, '不超过 1/2 茶匙', 'No more than 1/2 tsp'),
    ],
    '一碗左右米饭即可。冷藏米饭先捏散，胡萝卜和火腿切成小丁。',
    'Use about one bowl of rice. Break up cold rice first and cut carrot and ham into small dice.',
    [
      P(
        '准备',
        'Prepare',
        '准备约 1 碗米饭，不要太多。冷藏米饭先用手捏散。胡萝卜先横切成小段，再横、竖、斜各切几刀成小丁；火腿横竖各切两刀成小丁。打匀 2 个鸡蛋。',
        'Use about one bowl of rice, not more. Break up cold rice by hand. Cut carrot into small dice with a few crosswise, lengthwise, and diagonal cuts. Make ham dice with two crosswise and two lengthwise cuts. Beat 2 eggs.',
      ),
      P(
        '炒蛋',
        'Cook the egg',
        '6 档中火热锅后加油，倒入蛋液。鸡蛋快熟、仍有一点嫩时盛出，不要炒老。',
        'Heat the pan at level 6, then add oil and egg. Remove the egg when it is nearly cooked and still tender.',
        6,
      ),
      P(
        '炒胡萝卜和火腿',
        'Cook carrot and ham',
        '保持 6 档，先下胡萝卜丁炒约 2 分钟，再下火腿丁炒约 1 分钟。胡萝卜应变软但仍有一点脆感。',
        'Keep level 6. Cook carrot for about 2 minutes, then add ham for about 1 minute. Carrot should soften while keeping a little bite.',
        6,
      ),
      P(
        '炒饭并合味',
        'Fry the rice and finish',
        '加入捏散的米饭，6–7 档不断翻炒到米饭松散、热透。最后倒回鸡蛋翻匀。生抽和蚝油都只能少量加入，尝味后立即关火，避免过咸。',
        'Add the loosened rice and toss at level 6–7 until separate and steaming. Return the egg and toss through. Use only a little light soy sauce and oyster sauce, taste, then switch off so the rice does not become too salty.',
        7,
      ),
    ],
    1,
